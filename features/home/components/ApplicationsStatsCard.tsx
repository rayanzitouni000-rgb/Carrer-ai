...
import { APPLICATION_STATS } from '../constants/mockData';
import { useAnimatedCounter } from '../hooks';

function StatItem({ stat, index }: { stat: (typeof APPLICATION_STATS)[0]; index: number }) {
    ...
    <View style={styles.section}>
      ...
      <Card variant="elevated" padding="4">
        <View style={styles.grid}>
          {APPLICATION_STATS.map((stat, index) => (
