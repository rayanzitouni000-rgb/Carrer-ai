...
export const CHAT_SMART_ACTIONS: SmartAction[] = [
  ...
  { id: '2', label: 'Practice Interview', icon: 'mic-outline', route: '/interview', gradient: ['#06B6D4', '#3B82F6'] },
  { id: '3', label: 'Cover Letter', icon: 'create-outline', route: '/(tabs)/ai-chat', gradient: ['#8B5CF6', '#EC4899'] },
